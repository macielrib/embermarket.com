  ...
  return (
    <>
      <section className="flex flex-col mx-auto justify-center w-full bg- py-6 px-2 lg:py-16 lg:px-12">
        <div className="flex justify-center lg:justify-start px-2 py-6">
          <Link
            href="#"
          ...
          >
            Voltar ao Início <IoReturnDownBack className="h-4 w-4" />
          </Link>
        </div>
                ...
                <div className="flex flex-col w-full">
                  ...
                  <div className="flex flex-col py-2 lg:px-8">
                    <ul className="text-white font-dmsans font-medium flex flex-col gap-1 py-2">
                      ...
                      <li>
                        <span className="text-red-500">Há riscos?</span> Não, as
                        contas não são de revendas, nós mesmos fornecemos
                      ...
                      <li>
                        ...
                        clientes evitando qualquer problema em suas transações.
                      </li>
                    </ul>
                    <span className="text-[#fff9] font-dmsans font-normal text-sm">
